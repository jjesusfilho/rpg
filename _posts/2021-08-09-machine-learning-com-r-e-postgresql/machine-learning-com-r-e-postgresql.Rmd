...
Um desafio a ser enfrentado é que modelos estatísticos e de machine learning geralmente retornam uma lista com uma classe atribuída. No entanto, o PostgreSQL não reconhece listas do R. 
...
Para finalizar, vamos criar mais uma função para rodar floresta aleatória. Uma vez que o  princípio é o mesmo, iremos usar somente os argumentos fórmula e data. Se você quiser, pode ir adiante e adicionar os demais argumentos. Usaremos o pacote `ranger`. Portanto, é preciso tê-lo instalado, além do dplyr.
